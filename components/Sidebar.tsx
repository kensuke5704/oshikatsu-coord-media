        ...
        <ul className="mt-4 space-y-4">
          {summary.map((item) => (
            <li key={item} className="flex gap-3 text-sm font-bold leading-7 text-[#4a403b]">
              <span className="mt-1 grid size-5 shrink-0 place-items-center rounded-[6px] bg-[#fff3f1] text-[#b66f79]">
        ...
        <div className="mt-4 space-y-4">
          {related.slice(0, 4).map((article, index) => (
            <Link
              ...
              className="grid grid-cols-[2rem_1fr] gap-3 rounded-[8px] p-2 transition hover:bg-[#fff7f5]"
            >
              <span className="grid size-8 place-items-center rounded-[6px] bg-[#b66f79] text-sm font-black text-white">
                {index + 1}
              </span>
        ...
        <div className="mt-4 space-y-2">
          {categories.map((category) => (
            <Link
              ...
              className="flex items-center justify-between rounded-[8px] px-2 py-2 text-sm font-bold text-[#4a403b] transition hover:bg-[#fff7f5] hover:text-[#b66f79]"
            >
