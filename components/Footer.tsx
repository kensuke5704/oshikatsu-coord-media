...
export function Footer() {
  return (
    <footer className="border-t border-[#eadfda] bg-[#fffdfb]">
      <div className="mx-auto grid max-w-7xl gap-4 px-4 pb-3 pt-5 sm:px-6 lg:grid-cols-[1.3fr_1fr] lg:px-8">
        <div>
        ...
        <div className="grid content-start gap-2 text-sm font-bold text-[#4a403b] sm:grid-cols-2">
